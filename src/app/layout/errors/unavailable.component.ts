                        ...
                        <p-fluid>
                            <div class="custom-form-grid">
                                ...
                                <div class="custom-form-field col-span-12 text-center mb-4">
                                    ...
                                    <p style="color: var(--p-gray-400);">¡Volvemos enseguida!</p>
                                    <p-divider />
                                </div>

                                <div class="custom-form-field md:col-span-12">
                                    <p-button label="Comprobar" styleClass="w-full" [icon]="FontAwesome.ARROW_ROTATE_RIGHT_SOLID" [raised]="true" severity="info" (onClick)="back()" />
                                </div>
                            </div>
                        </p-fluid>
                    </div>
