...
import {
    AddressComponent
} from '@/pages/core/roles/external/components/guide-accreditation/steps/step1/address/address.component';
...
} from '@/pages/core/roles/guide-technician/components/process/checklist/checklist-form/checklist-form.component';
import {
...
import {
    GuideDataComponent
} from '@/pages/core/roles/guide-technician/components/process/checklist/guide-data/guide-data.component';

@Component({
    selector: 'app-checklist',
    imports: [ChecklistFormComponent, GuideDataComponent],
