...
export class GroundLocalsComponent {
    ...
    buildForm() {
        this.form = this.formBuilder.group({
            ...
            hasLandUse: [false, [Validators.required]]
        });
    ...
    getFormErrors(): string[] {
        ...
        if (this.isProtectedAreaField.invalid) errors.push('¿Su establecimiento se encuentra dentro del Subsistema Estatal del Sistema Nacional de Areas Protegidas?');
