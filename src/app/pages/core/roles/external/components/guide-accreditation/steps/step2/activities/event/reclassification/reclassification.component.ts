...
} from '@modules/core/roles/external/components/accreditation/steps/step3/activities/park/shared/physical-space/physical-space.component';

@Component({
    selector: 'app-reclassification',
    imports: [PeopleCapacityComponent, Button, PhysicalSpaceComponent],
    templateUrl: './reclassification.component.html',
    styleUrl: './reclassification.component.scss'
})
export class ReclassificationComponent {
