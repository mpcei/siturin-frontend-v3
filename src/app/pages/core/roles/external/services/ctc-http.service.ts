...
import { CtcInterface } from '@modules/core/interfaces/ctc.interface';
...
export class CtcHttpService {

  private readonly _httpClient = inject(HttpClient);
  private readonly _apiUrl = `${environment.API_URL}/core/external/process-ctc`;
  ...
  createRegistration(payload: CtcInterface ) {
  ...
  update(id: string, payload: CtcInterface) {
          const url = `${this._apiUrl}/${id}`;
